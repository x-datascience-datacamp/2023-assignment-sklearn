...
class KNearestNeighbors(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, X, y):
        ...
        if self.n_neighbors > len(self.X_):
            raise ValueError("Number of neighbors cannot be greater the number of training samples.")
...
class MonthlySplit(BaseCrossValidator):
    ...
    def split(self, X, y, groups=None):
        ...
        X_grouped = X_copy.sort_values(by=self.time_col).groupby(pd.Grouper(key=self.time_col, freq="M"))
